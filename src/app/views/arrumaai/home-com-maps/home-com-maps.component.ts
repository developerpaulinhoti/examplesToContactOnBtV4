...
import { google, googleMap, Google} from 'google-maps';


@Component({
  selector: 'app-home-com-maps',
  templateUrl: './home-com-maps.component.html',
  styleUrls: ['./home-com-maps.component.css']
})
export class HomeComMapsComponent implements OnInit {
  ...
  function headerNsliderResize() {
    ...
    Hh3slider.css("margin-top", mHeight + 'px');
      ...
      headerNsliderResize();
      var priceSlider = document.getElementById('price-range-filter')  as noUiSlider.Instance;
      if (priceSlider) {
